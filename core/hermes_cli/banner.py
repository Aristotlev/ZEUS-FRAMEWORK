...
HERMES_CADUCEUS = ZEUS_THUNDERBOLT
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]Zeus Framework[/]")
    ...
    agent_name = _skin_branding("agent_name", "Zeus")
